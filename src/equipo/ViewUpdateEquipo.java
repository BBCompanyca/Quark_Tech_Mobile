...
import static equipo.ViewRegisterEquipo.jTextField_Capacity;
...
public class ViewUpdateEquipo extends javax.swing.JPanel {
    ...
    public ViewUpdateEquipo() {
        ...
        jLabel_Title.setText("Modificación de Equipo - " + TableEquipos.code);
    ...
    private void initComponents() {
        ...
        jButton_UpdateEquipo.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void jButton_UpdateEquipoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_UpdateEquipoMousePressed
        ...
        UpdateEquipo updateEquipo = new UpdateEquipo(ID, brand, model, color, capacity, daywarranty);
    ...
    private void getInformation() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("select id_equipo, brand, model, color, capacity, day_warranty "
                    + "from equipo where code = '" + TableEquipos.code + "'");
