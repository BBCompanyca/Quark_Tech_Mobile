...
public class Information_Solicitudes extends javax.swing.JPanel {
    ...
    public Information_Solicitudes(Request request) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton_Rechazar.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jButton_Accept.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void jButton_AcceptMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_AcceptMousePressed
           ...
           try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "select status from warranty where id_warranty = '" + request.getRequestID() + "'");
    ...
    private void setDataRequest() {
        ...
        jLabel_Equipo.setText("Equipo: " + request.getBrand());
        jLabel_Model.setText("Módelo: " + request.getModel());
        jLabel_Color.setText("Color: " + request.getColor());
        jLabel_Serial.setText("Serial: " + request.getSerial());
