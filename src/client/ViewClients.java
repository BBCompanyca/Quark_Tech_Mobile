...
public class ViewClients extends javax.swing.JPanel {
    ...
    FilterRequestHistory searchClients = new FilterRequestHistory();
    ...
    private void jTextField_Search_ClientKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_Search_ClientKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            FilterRequestClient filterRequestClient = new FilterRequestClient();
            filterRequestClient.filterRequestClient(search);
    ...
    private void jButton_Update_ClientMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_Update_ClientMousePressed
        ...
        if (fila_point > -1) {
            ...
            ID = (int) getInstanceClient().getValueAt(fila_point, columna_point);
    ...
    private void jButton_Delete_ClientMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_Delete_ClientMousePressed
        ...
        if (fila_point > -1) {
            ...
            ID = (int) getInstanceClient().getValueAt(fila_point, columna_point);
            name = (String) getInstanceClient().getValueAt(fila_point, 1);
            ...
            if (value == 0) {
                ...
                try {
                    ...
                    getInstanceClient().removeRow(fila_point);
    ...
    private void getClients() {
        ...
        try {
            ...
            jTable_Client = new JTable(getInstanceClient());
            jScrollPane_C.setViewportView(jTable_Client);

            getInstanceClient().setColumnCount(0);
            getInstanceClient().setRowCount(0);

            getInstanceClient().addColumn("ID");
            getInstanceClient().addColumn("Nombre");
            getInstanceClient().addColumn("Teléfono");
            getInstanceClient().addColumn("Cédula");
            getInstanceClient().addColumn("Dirección");
            getInstanceClient().addColumn("Registrado Por");
    ...
    public static DefaultTableModel getInstanceClient() {
